...
class DetailsTab(AkmPanel):
    ...
    def build_ui(self):
        ...
        self.app.btn(action_row, "Audio wählen", self.app.choose_audio_path_for_details, quiet=True, width=118).pack(side="left", padx=(0, SPACE_XS))
        self.app.btn(action_row, "Finder", self.app.open_audio_path_in_finder, quiet=True, width=84).pack(side="left", padx=(0, SPACE_XS))
        self.app.btn(action_row, "Zurück", self.app.clear_details_form, quiet=True, width=84).pack(side="left")
